...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pedido.tipo_pagamento'
        db.alter_column('clearsale_pedido', 'tipo_pagamento', self.gf('django.db.models.fields.IntegerField')(max_length=2))

        # Changing field 'Pedido.parcelas'
        db.alter_column('clearsale_pedido', 'parcelas', self.gf('django.db.models.fields.IntegerField')(max_length=2))

        # Changing field 'Pedido.tipo_cartao'
        db.alter_column('clearsale_pedido', 'tipo_cartao', self.gf('django.db.models.fields.IntegerField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'Pedido.tipo_pagamento'
        db.alter_column('clearsale_pedido', 'tipo_pagamento', self.gf('django.db.models.fields.FloatField')(max_length=2))

        # Changing field 'Pedido.parcelas'
        db.alter_column('clearsale_pedido', 'parcelas', self.gf('django.db.models.fields.FloatField')(max_length=2))

        # Changing field 'Pedido.tipo_cartao'
        db.alter_column('clearsale_pedido', 'tipo_cartao', self.gf('django.db.models.fields.FloatField')(max_length=2, null=True))
    ...
    models = {
        ...
        'clearsale.pedido': {
            ...
            'parcelas': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
            ...
            'tipo_cartao': ('django.db.models.fields.IntegerField', [], {'max_length': '2', 'null': 'True', 'blank': 'True'}),
            'tipo_pagamento': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
        ...
        'clearsale.pedidoitem': {
            ...
            'item_qtd': ('django.db.models.fields.IntegerField', [], {'max_length': '2'}),
