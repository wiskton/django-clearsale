...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PedidoItem.item_qtd'
        db.alter_column('clearsale_pedidoitem', 'item_qtd', self.gf('django.db.models.fields.IntegerField')(max_length=2))

    def backwards(self, orm):

        # Changing field 'PedidoItem.item_qtd'
        db.alter_column('clearsale_pedidoitem', 'item_qtd', self.gf('django.db.models.fields.FloatField')(max_length=2))
