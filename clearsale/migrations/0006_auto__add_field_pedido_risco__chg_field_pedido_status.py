...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Pedido.risco'
        db.add_column('clearsale_pedido', 'risco',
                      self.gf('django.db.models.fields.CharField')(default='baixo', max_length=255),
                      keep_default=False)


        # Changing field 'Pedido.status'
        db.alter_column('clearsale_pedido', 'status', self.gf('django.db.models.fields.CharField')(max_length=10))

    def backwards(self, orm):
        # Deleting field 'Pedido.risco'
        db.delete_column('clearsale_pedido', 'risco')


        # Changing field 'Pedido.status'
        db.alter_column('clearsale_pedido', 'status', self.gf('django.db.models.fields.CharField')(max_length=3))
    ...
    models = {
        ...
        'clearsale.pedido': {
            ...
            'risco': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'status': ('django.db.models.fields.CharField', [], {'default': "'PEN'", 'max_length': '10'}),
